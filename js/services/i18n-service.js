...
const DICTS = {
  pt: {
    ...
    "nav.cobertura-regional": "Cobertura Regional",
    "nav.favoritos": "Favoritos e Preferências",
    "nav.backup": "Backup & Exportação",
    "nav.estrategia-ai": "Estratégia AI",
    "nav.usuarios": "Usuários",
    "nav.administracao": "Administração",
    "nav.category.visao-geral": "Visão geral",
    "nav.category.cadastros": "Cadastros",
    "nav.category.analises": "Análises e inteligência",
    "nav.category.produtividade": "Produtividade",
    "nav.category.administracao": "Administração",
  ...
  es: {
    ...
    "nav.cobertura-regional": "Cobertura Regional",
    "nav.favoritos": "Favoritos y Preferencias",
    "nav.backup": "Backup y Exportación",
    "nav.estrategia-ai": "Estrategia AI",
    "nav.usuarios": "Usuarios",
    "nav.administracao": "Administración",
    "nav.category.visao-geral": "Visión general",
    "nav.category.cadastros": "Registros",
    "nav.category.analises": "Análisis e inteligencia",
    "nav.category.produtividade": "Productividad",
    "nav.category.administracao": "Administración",
  ...
  en: {
    ...
    "nav.cobertura-regional": "Regional Coverage",
    "nav.favoritos": "Favorites & Preferences",
    "nav.backup": "Backup & Export",
    "nav.estrategia-ai": "AI Strategy",
    "nav.usuarios": "Users",
    "nav.administracao": "Administration",
    "nav.category.visao-geral": "Overview",
    "nav.category.cadastros": "Records",
    "nav.category.analises": "Analytics & intelligence",
    "nav.category.produtividade": "Productivity",
    "nav.category.administracao": "Administration",
